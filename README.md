# PrepGuide - The Framework Room

An interactive, glassmorphic single-page application combining consulting frameworks and a corporate finance lab.
...
1. Clone this repository:
   ```bash
   git clone git@github.com:suryateja4104-stark/PrepGuide.git
   ```
2. Open [framework-room.html](framework-room.html) in any modern web browser.
